...
SAMPLE_SPREADSHEET_ID = '1fajPIayHpZ5IWN8Ldzpj5QfbTUtrRoCaoxm1Gkc_pj0'
SAMPLE_RANGE_NAME = 'Página1!A1:b14'
...
def main():
    ...
    try:
        ...
        # adicionar editar iformações
        # valores_adicionar = [
        #     ['dezembro', 'R$ 100000']
        # ]

        # result = sheet.values().update(spreadsheetId=SAMPLE_SPREADSHEET_ID,
        #                             range="A14", valueInputOption="USER_ENTERED",
        #                             body={'values': valores_adicionar}).execute()
